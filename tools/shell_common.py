...
SECTIONS = [
    ...
    {"key": "sayding", "title": "Металлосайдинг", "url": "krovlya-sayding.html",
     "img": "img/cat-sayding.jpg", "note": "Фасад и софиты, 22 цвета"},
]
