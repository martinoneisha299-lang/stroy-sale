...
def build_index():
  ...
  <section class="hero">
    ...
    <div class="wrap hero-in"><div class="hero-copy">
      ...
      <p>Кирпич, тротуарная плитка, металлочерепица и профнастил напрямую
         с заводов. Подберём под проект, рассчитаем количество и доставим
         на объект.</p>
      <!-- Только цифры: условия оплаты и доставки идут ниже, в ленте условий,
           иначе первый экран телефона занимает один заголовок. -->
      <div class="hero-facts">
        <div><b>470+</b><span>позиций в каталоге</span></div>
        <div><b>5 минут</b><span>перезвоним после заявки</span></div>
