...
утверждена) — везде «Цена по запросу» и кнопки связи. Все продуктовые фото
поставщика под тайловым водяным знаком, поэтому визуальный язык раздела:
чистые кадры из галереи завода + чертежи профилей + кружки реальных
текстур покрытий.
...
MCH = [
    dict(
        ...
        meta="классический профиль · волна 24 мм",
...
PROF = [
    dict(
        ...
        meta="заборы и обшивка · волна 8 мм",
    ...
    dict(
        ...
        meta="заборы и стены · волна 10 мм",
    ...
    dict(
        ...
        meta="универсальный · волна 21 мм",
    ...
    dict(
        ...
        meta="кровля и заборы · волна 20 мм",
    ...
    dict(
        ...
        meta="кровля и навесы · волна 35 мм",
